        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceTermsId = table.Column<string>(type: "TEXT", nullable: false),
                    Paid = table.Column<double>(type: "REAL", nullable: false),
                    Credit = table.Column<double>(type: "REAL", nullable: false),
                    TaxRated = table.Column<double>(type: "REAL", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPrice = table.Column<double>(type: "REAL", nullable: false, computedColumnSql: "[UnitPrice] * [Quantity]"),
                    UserId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceLineItems_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceLineItems_UserId",
                table: "InvoiceLineItems",
                column: "UserId");
